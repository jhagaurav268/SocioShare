...
import FacebookIcon from '@salesforce/resourceUrl/FacebookLogoIcon';
import IinkedInIcon from '@salesforce/resourceUrl/LinkedInLogoIcon';
export default class PostGroup extends LightningElement {

    // fbIcon = FacebookIcon;
    // inkIcon = IinkedInIcon;
    // value = '';

    // get options() {
    //     return [
    //         {label: 'Post to Facebook and Instagram', value: ''},
